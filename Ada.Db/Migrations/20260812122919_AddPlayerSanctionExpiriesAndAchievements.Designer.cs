...
namespace Ada.Db.Migrations
{
    ...
    [Migration("20260812122919_AddPlayerSanctionExpiriesAndAchievements")]
    partial class AddPlayerSanctionExpiriesAndAchievements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ada.Db.Models.BannedIpAddress", b =>
                {
                    ...
                    b.HasIndex("IpAddress")
                        .HasDatabaseName("ix_banned_ip_addresses_ip_address");
            ...
            modelBuilder.Entity("Ada.Db.Models.BannedMachine", b =>
                {
                    ...
                    b.HasIndex("MachineId")
                        .HasDatabaseName("ix_banned_machines_machine_id");
            ...
            modelBuilder.Entity("Ada.Db.Models.Players.PlayerPet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("PubliclyBreedable")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("publicly_breedable");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_player_pets");

                    b.HasIndex("PlayerId")
                        .HasDatabaseName("ix_player_pets_player_id");

                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_player_pets_room_id");

                    b.ToTable("player_pets", (string)null);
                });
            ...
            modelBuilder.Entity("Ada.Db.Models.Players.PlayerSsoToken", b =>
                {
                    ...
                    b.HasIndex("Token")
                        .HasDatabaseName("ix_player_sso_tokens_token");
            ...
            modelBuilder.Entity("Ada.Db.Models.Players.PlayerPet", b =>
                {
                    b.HasOne("Ada.Db.Models.Players.Player", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_player_pets_players_player_id");
                });
