...
[PacketId(EventHandlerId.GuildAcceptMembership)]
public class GuildAcceptMembershipEventHandler(IGroupRepository groupRepository) : INetworkPacketEventHandler
{
    ...
    public async Task HandleAsync(INetworkClient client)
    {
        ...
        await groupRepository.SetPendingAsync(group.Id, UserId, false);
