...
[PacketId(EventHandlerId.GuildSetAdmin)]
public class GuildSetAdminEventHandler(IGroupRepository groupRepository) : INetworkPacketEventHandler
{
    ...
    public async Task HandleAsync(INetworkClient client)
    {
        ...
        await groupRepository.SetRankAsync(group.Id, UserId, GroupMemberRank.Admin);
