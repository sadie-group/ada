...
public static class EventHandlerId
{
    ...
    public const short GuideToolUpdate = 1922;
    public const short GuideAssistanceRequest = 3338;
    public const short GuideRequestHandled = 1424;
    public const short GuideRequestCancelled = 291;
    public const short GuideSessionClose = 887;
    public const short GuideSessionMessage = 3899;
    public const short GuideSessionTyping = 519;
    public const short GuideSessionInviteUser = 234;
    public const short GuideSessionVisitUser = 1052;
    public const short GuideRecommendHelper = 477;
    public const short GuideReportHelper = 3969;
    public const short NavigatorAddSavedSearch = 2226;
    public const short NavigatorDeleteSavedSearch = 1954;
    public const short NavigatorCollapseCategory = 1834;
    public const short NavigatorUncollapseCategory = 637;
    public const short NavigatorCategoryListMode = 1202;
    public const short NavigatorTags = 826;
    public const short RoomCanCreate = 2128;
    public const short ModToolsSanctionMute = 1945;
    public const short ModToolsSanctionTradeLock = 3742;
    public const short ModToolsIssueChangeTopic = 1392;
    public const short ModToolsIssueDefaultSanction = 2717;
    public const short ReportRoom = 3267;
    public const short GetRoomRights = 3385;
    public const short RoomRemoveAllRights = 2683;
    public const short RoomRemoveMyRights = 3182;
    public const short PlayerAddFavouriteRoom = 3817;
    public const short PlayerDeleteFavouriteRoom = 309;
    public const short GetRoomFilterList = 1911;
    public const short ModifyRoomFilterList = 3001;
    public const short RoomTradingModify = 1444;
    public const short RoomTradingRemoveItem = 3845;
    public const short PlayerSetChatPreference = 1262;
    public const short PlayerSetSoundSettings = 1367;
    public const short PlayerSetFriendBarState = 2313;
    public const short PlayerSetFocusPreference = 1461;
    public const short PlayerSetMessengerInviteStatus = 1086;
    public const short RoomStickyNoteAdd = 2248;
    public const short RoomStickyNoteGet = 3964;
    public const short RoomStickyNoteUpdate = 3666;
    public const short RoomStickyNoteDelete = 3336;
    public const short RoomPlayerBotPickedUp = 3323;
    public const short PlayerAvatarEffectSelected = 1752;
    public const short PlayerAvatarEffectActivated = 2959;
    public const short PlayerSetActivatedBadges = 644;
    public const short RoomSetThumbnail = 1982;
    public const short PlayerCheckValidName = 3950;
    public const short GetPromotableRooms = 2283;
    public const short PlayerRedeemVoucher = 339;
